...
- [ ] T347 Validate fresh-clone onboarding, local Supabase start/reset/types, fixture providers, four-locale seed catalog, test/build, Netlify preview, and recovery instructions solely from README.md and docs/operations/ in docs/quality/fresh-clone-evidence.md
